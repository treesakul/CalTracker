...
class Main_Page_UI(QMainWindow):
    ...
    def mainPageInit(self):
        loader = QUiLoader()
        form = loader.load("C:/Users/User/Desktop/CalTracker/UIDesigner/MainPageUI.ui", None)
    ...
    def dia_add_food(self):
        ...
        d.self.foodDai_ok_bt.clicked.connect(d.ok)
        d.self.foodDai_add_bt.clicked.connect(d.addd)
        d.self.foodDai_delete_bt.clicked.connect(d.delete)
